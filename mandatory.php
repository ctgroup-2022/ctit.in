...
<!-- Navbar include End -->
 ...
 <div class="container-fluid bg-primary py-5 mb-5 page-header">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Mandatory Disclosure & EOA</h1>
    ...
    <!-- Header End -->
    <div>
         <h3 class="text-center">Mandatory Disclosure</h3>
...
<table class="table table-striped table-responsive">
  ...
  <thead>
    ...
    <tr>
        <td class="text-center" colspan="6"><strong>Mandatory Disclosure</strong></td>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td align="justify">Mandatory Disclosure
</td>
      <td>
      <!-- <img  src="img/new-gif-image.gif" style="height:30px; width:30px;"> -->
      </td>
      <td></td>
      <td><a href="pdf\CTIT mandatory discloser 2025-26.pdf" target=_blank>View PDF</td>
...
<h3 class="text-center">EOA</h3><br>
...
<thead>
    ...
    <tr>
        <td class="text-center" colspan="6"><strong>EOA</strong></td>
    </tr>
  </thead>
  <tbody>
...
<!-- 
    <tr>
      <th scope="row">17</th>
      <td align="justify">EOA-CTIEMT-2020-21</td>
      <td></td>
      <td></td>
      <td><a href="pdf\AICTE APPROVALS\EOA-CTIEMT-2020-21.PDF" target=_blank>View PDF</td>
    </tr>

    <tr>
      <th scope="row">18</th>
      <td align="justify">EOA-CTIEMT-2021-22</td>
      <td></td>
      <td></td>
    ...
    <tr>
      <th scope="row">19</th>
      <td align="justify">EOA-CTIEMT-2022-23</td>
      <td></td>
      <td></td>
      <td><a href="pdf\AICTE EOA\CTIT AICTE EOA ALL (1)\CTIT AICTE EOA ALL\EOA-CTIT-2021-22.PDF" target=_blank>View PDF</td>
    </tr>
    ...
    <tr>
      <th scope="row">20</th>
      <td align="justify">EOA-CTIEMT-2023-24 Corrigendum</td>
      <td></td>
      <td></td>
      <td><a href="pdf\AICTE EOA\CTIT AICTE EOA ALL (1)\CTIT AICTE EOA ALL\EOA-CTIT-2024-25 Corrigendum.pdf" target=_blank>View PDF</td>
    </tr>
    ...
    <tr>
      <th scope="row">19</th>
      <td align="justify">EOA-CTIEMT-2024-25 Corrigendum</td>
      <td></td>
      <td></td>
      <td><a href="pdf\AICTE EOA\CTIT AICTE EOA ALL (1)\CTIT AICTE EOA ALL\LOI-CTIT 2008.pdf" target=_blank>View PDF</td>
    </tr> -->
...
<table class="table table-striped table-responsive">
  ...
  <thead>
    ...
    <tr>
        <td class="text-center" colspan="6"><strong>PG - MBA/MCA COURSES</strong></td>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      <th scope="row">1</th>
      <td align="justify">Masters In Computer Applications</td>
      <td>30</td>
    </tr>
    <tr>
      <th scope="row">2</th>
      <td align="justify">MBA</td>
      <td>90</td>
    </tr>
