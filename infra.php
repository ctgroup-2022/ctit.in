...
<!-- Navbar include End -->
 ...
 <div class="container-fluid bg-primary py-5 mb-5 page-header">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Infrastructure</h1>
    ...
    <a class="list-group-item list-group-item-action active" id="list-class-list" data-bs-toggle="list" href="#list-class" role="tab" aria-controls="list-class">Class Rooms</a>
      <a class="list-group-item list-group-item-action" id="list-library-list" data-bs-toggle="list" href="#list-library" role="tab" aria-controls="list-library">Library</a>
      <a class="list-group-item list-group-item-action" id="list-labs-list" data-bs-toggle="list" href="#list-labs" role="tab" aria-controls="list-labs">Labs</a>
      <a class="list-group-item list-group-item-action" id="list-medicare-list" data-bs-toggle="list" href="#list-medicare" role="tab" aria-controls="list-medicare">Medicare Complex</a>
      <a class="list-group-item list-group-item-action" id="list-workshop-list" data-bs-toggle="list" href="#list-workshop" role="tab" aria-controls="list-workshop">Workshops</a>
      <a class="list-group-item list-group-item-action" id="list-can-list" data-bs-toggle="list" href="#list-can" role="tab" aria-controls="list-can">Central Canteen</a>
      <a class="list-group-item list-group-item-action" id="list-hostel-list" data-bs-toggle="list" href="#list-hostel" role="tab" aria-controls="list-hostel">Hostel</a>
      <a class="list-group-item list-group-item-action" id="list-audi-list" data-bs-toggle="list" href="#list-audi" role="tab" aria-controls="list-audi">Central Auditorium</a>
      <a class="list-group-item list-group-item-action" id="list-sports-list" data-bs-toggle="list" href="#list-sports" role="tab" aria-controls="list-Sports">Sports</a>
      <a class="list-group-item list-group-item-action" id="list-hall-list" data-bs-toggle="list" href="#list-hall" role="tab" aria-controls="list-hall">Seminar Hall</a>
      <a class="list-group-item list-group-item-action" id="list-bank-list" data-bs-toggle="list" href="#list-bank" role="tab" aria-controls="list-hall">Bank</a>
    </div>
  </div>
  ...
  <div class="tab-content" id="nav-tabContent">
      ...
      <p>&nbsp;</p>
        <h4>ClassRoom @ CTIT</h4>
        
        <br><br>
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-5">
            <img class="w-100 h-100" src="img/2.jpg"></div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <p align="justify">Classrooms are equipped with modern teaching aids like: Projectors, White Boards and Green Boards also. There is adequate lighting and ventilation in each classroom to make students feel comfortable and legibility to read properly.  
                </p>
                <p align="justify">The classrooms are quite spacious with seating capacity of 61 to 68 students in different classrooms, adding to this, equipped with projectors.</p>
            </div>
        </div>
        </div>
...
<!-- Library section starts -->
      ...
      <p>&nbsp;</p>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-5">
            <img class="w-100 h-100" src="img/infra/library.jpg"></div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                <p align="justify">The institute has mass AC library which comprises of 28500 plus Books on different subjects, reference books covering atlases, biographies, dictionaries, encyclopaedias, manuals, yearbooks, etc. Students and Faculty frequently visit library to enhance knowledge and to explore more. Around 300 students and faculty members visit library daily and around 200 access online resources available in the library. Many newspapers, journals and magazines are available in the library. Library is Wi-Fi enabled and having a seating capacity of 150 persons. There are separate corner stands for newspapers and separate reading room area. The library has got subscription of e-journals like Delnet and J-gate. Libraries are not only the places to think but also an informal work area where students gather to collaborate. </p>
                <p align="justify">Library Automation Software: "Nimbus" used for automating all the services of the library.<br>
                The library has a wide collection of books on various subjects including a large number. With an annual subscription of National and International print journals, e-journals, e-magazines, e-books, and audio eBooks. 20 computers have been installed in the multimedia section for students and faculty for project reports dissertations. Back volume of Journals is available in the research section. Library is equipped with CCTV cameras with overall monitoring and surveillance.  
                </p>
            </div>
        </div>
        </div>
...
<!-- Bank Section starts -->
      ...
      <p>&nbsp;</p>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-5">
            <img class="w-100 h-100" src="img/bank/1.jpg"></div>
            <div class="col-lg-6 col-md-6 col-sm-6">
            <p align="justify">The institute has a branch of PNB Bank with ATM facility too.</p>
            </div>
        </div>
        </div>
        <!-- Bank section ends -->
      ...
      <div class="row"><p>&nbsp;</p>
        <!-- <h3 class="text-center">Computer Lab</h3><hr> -->
            <div class="col-lg-5 col-md-5 col-sm-5">
        <img class="w-100 h-100" src="img/labs/8.jpg"></div>
        <div class="col-lg-6 col-md-6 col-sm-6">
                <p align="justify">There are different laboratories in the institute for Computer Science Engineering, Civil Engineering, Mechanical Engineering, Electronics and Communication Engineering. The laboratories are categorized domain wise. All laboratories have all the latest equipment and instruments to do subject related practical work and to do any research-related work. Each laboratory is equipped with the latest and most accurate instruments.</p>
...
<!-- Lab section ends -->
 ...
 <!-- Medicare complex starts -->
      ...
      <p>&nbsp;</p><div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
                <p align="justify">The institute has excellent sports facilities for both indoor and outdoor games. It includes cricket ground, football ground, volleyball court, badminton court, table tennis court, facility to play throw ball, chess, carrom, and snooker. Yoga Centre and fitness Centre is available with all essential equipment to do gymnasium and yoga. All the dimensions of these play areas are as per the national and international standards.</p>
        </div>
        </div><hr>
