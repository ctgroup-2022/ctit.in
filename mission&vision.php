...
<!-- Navbar include End -->
 ...
 <div class="container-fluid bg-primary py-5 mb-5 page-header">
    ...
    <h3><strong>CTIT VISION & MISSION</strong></h3>
    <hr>
...
.</p>
    <h6>Mission</h6>
    <p>
    The primary mission is not only to provide the bookish knowledge to the students in their opted courses, but also to persuade them to make their future bright by becoming jurists, researchers, academicians, legal advisors, judicial officers and public prosecutors and contribute towards a society which is aware about their legal rights.</p>
    <ul align="justify">
    ...
    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
        <img class="h-100 w-100" src="img/mv.png">
    </div>
