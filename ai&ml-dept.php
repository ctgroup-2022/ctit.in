  ...
  <div class="col-sm-8 col-md-8">
    ...
    "pdf/faculty/Faculty 2023-24.pdf" 
      ...
      <!-- Events Starts -->
        ...
        <div class="row g-0">
            <div class="col-md-4">
                <img src="img/department/events-ai/1.png" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
                <div class="card-body">
                    <!-- <h5 class="card-title">Workshop on Deep Learning</h5> -->
                        <p class="card-text" align="justify">AI ML department organized an online lecture on Lecture on Artificial Intelligence and Generative Adversarial Networks by Prof J. Amudhavel University of Tartu, Estonia on 18 April 2023. Dr. Amudhavel briefed the students about the domains of Artificial Intelligence, Machine Learning, Deep Learning and how they are impacting everyday activities. He discussed the applications of AI and ML in social networks in creating content, segregating content and automation of office work. He discussed a few websites showcasing AI open-source projects for students. Students were interested in watching 3D and graphics generated by algorithms which are quite popular on various social media platforms. He shared certification courses and projects which students can take up and make a career in AI/ ML.</p>
                </div>
            </div>
        </div>
        </div>
            ...
            <div class="col-md-8">
                <div class="card-body">
                    <!-- <h5 class="card-title">Lecture on IPRs by Dr. Rajesh Singh</h5> -->
                        <p class="card-text" align="justify">Department of AI ML organized a guest lecture on Deep Learning on 7th March 2023. The resource person was Dr. Shefali Arora, Assistant Professor, NIT Jalandhar. Dr. Arora discussed the domains of Artificial Intelligence, Machine Learning, Deep Learning, Data Science and Explainable AI. She introduced to the students the term “explainable AI” which provides reasons for the actions advocated by the algorithms. This adds to the confidence in using the predictions generated by the algorithms in making decisions and policy making. Students asked questions about synthetic datasets and their authenticity in training the algorithms for their projects.</p>
                </div>
            </div>
            
            <div class="col-md-4">
                <img src="img/department/events-ai/2.jpg" class="img-fluid rounded-start" alt="...">
            </div>
        </div>
        </div>
        <div class="card mb-3" style="max-width:100%">
        <div class="row g-0">
            <div class="col-md-4">
                <img src="img/department/events-ai/3.jpg" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
                <div class="card-body">
                    <!-- <h5 class="card-title">Workshop on PC Troubleshooting and Operating System Installation </h5> -->
                        <p class="card-text" align="justify">AI ML department organized a webinar on Research Development of AI based smart grid integration. The resource person of the event was Dr. M. Venkateshkumar, Assistant Professor Amrita Vishwa Vidyapeetham, Chennai who explained the role of AI in power grid integration and its benefits.</p>
                </div>
            </div>
        </div>
        </div>
