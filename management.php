...
<!-- Navbar include End -->
 ...
 <div class="container-fluid bg-primary py-5 mb-5 page-header">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Management's Desk</h1>
    ...
    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
        ...
        <p align="justify">Career Transformation is more than CTIT's motto. It is the very reason we exist. Through research and scholarship we seek to produce transformative leaders who beat the odds and challenges and win all global battles. And through education 
...
<div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
    ...
    <p align="justify">In today’s volatile world where there is cutthroat competition in all fields, careers, and businesses, team CTIT is all set with sagacious vision and dreams to enhance, evolve and contribute to plunging learning outcomes in the education system. Understanding the room for monumental growth and potential in the Indian education system, 
    ...
    <p align="justify">CTIT is convinced that transformational education can produce world-class leaders capable of overcoming global challenges. Our team members can cultivate such leaders. Leaders with compassion, fortitude, and intellectual prudence.</p>
    ...
    <p align="justify">The mission of CTIT is to provide innovative and comprehensive educational services and resources to learners from various walks of life. We strive to create a positive learning environment where everyone has the opportunity to reach their full potential. We believe in the power of education and the importance of lifelong learning, and we are committed to helping our students To achieve this, we offer a holistic approach to education, incorporating both traditional and innovative learning styles. Our learning community is open to everyone who is invested in 
