        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Department of Electronics & Communication Engg</h1>
    ...
    <div class="tab-content" id="nav-tabContent">
      ...
      <!-- Hod Desk Starts -->
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <p align="justify">The department of ECE was established in the year 2004 with b.tech programme. The objectives for the establishment of the department are in line with the vision of CTIT to become an exemplary institute of nationally acknowledged stature and excellence in teaching, research and development. Furthermore, our academic program and learning environment have been designed to contribute to the quality and intellectual development of the students. We offer a wealth of opportunities for our faculty and students to contribute to a broad spectrum of research. Our faculty members make every effort to ensure that the students "learn how to learn" and how to become leaders and pioneers, emphasizing fundamental principles that respond to and create technological changes that challenge the exceptional ability of a ct student. The department gives exposure to its students, not only to the regular engineering curriculum but also to the aspirations of today's corporate world by inculcating a professional attitude in them. It also has a commitment for providing opportunities to students in diverse fields such as telecommunications, embedded systems etc. The programs are enriched by the variety of cultural, economic, and educational backgrounds of our students, faculty, and staff. The department also emphasizes on all round development of the faculty and laboratory staff by providing them conducive academic environment and necessary infrastructure for carrying out academic and research work.</p>
                <h4 class="text-end">Ms. Manpreet Kaur</h4>
            </div>
       </div>  
        </div>
      <!-- Hod Desk Ends --> 
      ...
      <!-- faculty list Ends --> 
       ...
       <div class="tab-pane fade" id="list-vm" role="tabpanel" aria-labelledby="list-vm-list">
        ...
        <div class="row">
          ...
          <h3>Vision</h3>
          <p align="justify">To impart quality technical education for developing professional engineers, researchers and entrepreneurs.</p>
          <h3>Mission</h3>
          <p align="justify">
               1. To provide fundamental knowledge in the field of Electronics & Communication Engineering.  <br>
               2. To facilitate a conducive environment to develop technical & professional skills. 
            </p>
</div>
       </div>  
        </div>
       ...
       <strong> <a href="https://ptu.ac.in/wp-content/uploads/2022/08/MBA-Upto-4th-Sem.-2021-onwards-affliated-colleges.pdf" class="text-center">Syllabus For MBA</a></strong>
        ...
        <h3 class="text-center">Laboratories</h3><hr>
          ...
          <div class="card mb-3" style="max-width:100%">
            <div class="row g-0">
            <div class="col-md-4">
                <img src="img/department/ece-labs/1.jpg" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
                <div class="card-body">
                    <h5 class="card-title">Digital Electronic Lab</h5>
                        <p class="card-text" align="justify">This lab continues our exploration of transistor switching circuits to include logic gates, latches, and flip-flops. We explore combinational circuits e.g. mux, encoder, parity generators, code converters etc. And sequential circuits e.g. flip-flops, shift registers, counters etc. Using small arrays of flip-flops.</p>
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="card mb-3" style="max-width:100%">
            <div class="row g-0">
            <div class="col-md-4">
                <img src="img/department/ece-labs/3.jpg" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
                <div class="card-body">
                    <h5 class="card-title">Communication Lab</h5>
                        <p class="card-text" align="justify"> 
                        The Purpose Of This Laboratory Is To Train The Students To Be Familiar With Analog Communication Systems: Amplitude And Angle Modulation And Demodulation Systems, Spectral Analysis Of These Operations, Super Heterodyne Noise Conditions. Digital Communication Systems: Pulse Code Modulation (PCM), Differential Pulse Code Modulation (DPCM), Delta Modulation (DM), Digital Modulation Schemes-Amplitude, Phase And Frequency Shift Keying Schemes (ASK, PSK, FSK), Matched Filter Receivers, Bandwidth Consideration And Probability Of Error Calculations For These Schemes, GSM, TDMA.
                        </p>
                </div>
            </div>
        </div>
